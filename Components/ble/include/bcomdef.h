...
#define BLE_BOND_DEVICE_ADR            0x81  //保存绑定的蓝牙地址
#define BLE_BOND_DEVICE_ADRTYPE        0x82  //保存绑定蓝牙地址类型
#define BLE_NVID_BPS_PARA              0x83  //保存蓝牙波特率
#define BLE_VEN_COMMUNICATION          0x84  //保存蓝牙通信handle
/** @} End BLE_NV_IDS */
